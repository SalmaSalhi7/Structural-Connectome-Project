...
def Analyze(img_d_path,img_s_path,gtab, run, subject):
    ...
    # ISSUE HERE: I'm getting a ValueError: slice step cannot be zero. I think it's referring to this line in the definition of the function: endpoints = [sl[0::len(sl)-1] for sl in streamlines]. I tried adjusting the syntax but nothing seems to be working. I had no problems with this function
    # before so not sure why there's an issue now. 
