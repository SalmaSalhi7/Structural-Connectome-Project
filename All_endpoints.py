...
def analyze(run, subject):
    ...
    reduced_label_title = '/Volumes/Toshiba4TB/' + subject + 'labels_originaltest_subject=' + subject.split(None, 1)[0] + run + '.pkl'
...
for subject in subjects:
    for run in p:
        ...
        title = '/Users/salmasalhi/my_code/HumanBrain_v2/' + subject + 'bi-directional_label_map-shorder=6-maxangle=45-gfa=0.25-subject=' + subject.split(None, 1)[0] + '.pkl'
